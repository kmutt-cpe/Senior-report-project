...
\end{figure}
\begin{figure}[!h]\centering
\fbox{\includegraphics[width=15cm]{./img/ch4/ch4_Cloudflare.jpg}}
...
\end{figure}
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 15cm]{./img/ch4/ch4_GetFAQ.jpg}}
\caption{GraphQL query FAQs from backend API}\label{fig:GraphQL query FAQs from backend API}
\end{figure}
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 15cm]{./img/ch4/chap4_get.jpg}}
