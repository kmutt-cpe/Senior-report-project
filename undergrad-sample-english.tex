...
Our world is becoming more technology driven. The population needs to have an awareness of technology like Artificial Intelligence (AI) for the country to become successful and reduce the workload of humans, as in the Computer Engineering department of King Mongkut’s University of Technology Thonburi. \\
Nowadays, many outsiders and insiders, whether students, teacher assistants, and staff may have many questions about departments, or the curriculum of each year etc. These same questions will be asked regularly. \\
Therefore, our team aims to develop the KMUTT CPE Chatbot System to help answering the frequently asked questions and general inquiries about the Computer Engineering department, KMUTT. It can also bring questions that chatbot cannot reply to officers and administration for their attention answer to the question and then the chatbot will send the answer back to the inquirer via the Facebook Messenger platform.
...
Many companies and organizations confront with lagging behind answering the question online. Lagging behind answering question because they have a lot of work to do and unmanageable work that goes to the staff, leading in a less interactive organization department and contact person. Computer Engineering department confront of this problem too. Computer Engineering staff has a lot of work to do. When people ask Computer Engineering Fanpage, it takes a long time to answer.\\
The lagging behind answering the question can be solved by using a chatbot, there are many types of chatbots, the most common of which is rule-based chatbots, which are used to lead a user through to offer choices and asks for data. This type of chatbot has its own set of questions and answers, and it simply waits for questions that match with the pattern to answer to user. Ruled-based chatbot is good at survey. The next type of chatbot is a chatbot that many companies use and will be used in the Computer Engineering department which is AI chatbot. AI chatbot is a chatbot that can study the conversation history log and able to predict the question from the user, then choose the answer that match to the question most. AI chatbot can answer like natural language and flexible context.\\
...
\ref*{fig:standard_rnn}, \nameref*{fig:standard_rnn}. It takes the output value from the previous
...
\begin{figure}[!h]\centering
\fbox{\includegraphics[width=14cm]{./img/ch4/new_software_architecture.png}}
...
\begin{figure}[!h]\centering
	\fbox{\includegraphics[width=14cm]{./img/ch4/azure_vm.png}}
...
\begin{figure}[!h]\centering
	\fbox{\includegraphics[width=14cm]{./img/ch4/nameDotCom.png}}
...
\begin{figure}[!h]\centering
	\fbox{\includegraphics[width=14cm]{./img/ch4/cloudflare_home.png}}
...
\begin{figure}[!h]\centering
	\fbox{\includegraphics[width=14cm]{./img/ch4/ci-cd-be.png}}
	\caption{Workflow log of backend API in GitHub Actions}\label{fig:ci-cd-be}
\end{figure}

\begin{figure}[!h]\centering
	\fbox{\includegraphics[width=14cm]{./img/ch4/ci-cd-fe.png}}
...
\begin{figure}[!h]\centering
	\fbox{\includegraphics[width=8cm]{./img/ch4/ch4_line_example.jpg}}
...
\begin{figure}[!h]\centering
	\fbox{\includegraphics[width=14cm]{./img/ch4/dialogflow_intent.png}}
...
\label{fb_messenger}
	...
	\begin{figure}[!h]\centering
		\fbox{\includegraphics[width=6cm]{./img/ch4/facebook_support.png}}
		\caption{Facebook support}\label{fig:Facebook support}
	\end{figure}

	\begin{figure}[!h]\centering
		\fbox{\includegraphics[width=14cm]{./img/ch4/facebook_appreview_requests_approve.png}}
...
\section{Knowledge Management Results}
	...
	\begin{figure}[!h]\centering
		\fbox{\includegraphics[width=12cm]{./img/ch4/Use case version 2.png}}
...
\pagebreak
	...
	\subsubsection{Landing Pages}
		\begin{figure}[!h]\centering
			\fbox{\includegraphics[width= 14cm]{./img/ch4/realUI/ui_landing_page.png}}
		...
		\begin{figure}[!h]\centering
			\fbox{\includegraphics[width= 14cm]{./img/ch4/realUI/ui_contact_page.png}}
		...
		\begin{figure}[!h]\centering
			\fbox{\includegraphics[width= 14cm]{./img/ch4/realUI/ui_login_page.png}}
	...
	\subsubsection{Question Management}
		\begin{figure}[!h]\centering
			\fbox{\includegraphics[width= 14cm]{./img/ch4/realUI/ui_category_selection_page_in_question_management.png}}
...
\pagebreak
		\begin{figure}[!h]\centering
			\fbox{\includegraphics[width= 14cm]{./img/ch4/realUI/ui_question_list_page_of_each_catrgory_in_question_management.png}}
		...
		\begin{figure}[!h]\centering
			\fbox{\includegraphics[width= 14cm]{./img/ch4/realUI/ui_question_information_page_in_question_management.png}}
		...
		\begin{figure}[!h]\centering
			\fbox{\includegraphics[width= 14cm]{./img/ch4/realUI/ui_create_question_page_in_question_management.png}}
		...
		\begin{figure}[!h]\centering
			\fbox{\includegraphics[width= 14cm]{./img/ch4/realUI/ui_edit_question_page_in_question_manageement.png}}
	...
	\subsubsection{Category Management}
		\begin{figure}[!h]\centering
			\fbox{\includegraphics[width= 14cm]{./img/ch4/realUI/ui_category_list_page_in_category_management.png}}
		...
		\begin{figure}[!h]\centering
			\fbox{\includegraphics[width= 14cm]{./img/ch4/realUI/ui_create_category_pop_up_in_category_management.png}}
		...
		\begin{figure}[!h]\centering
			\fbox{\includegraphics[width= 14cm]{./img/ch4/realUI/ui_edit_category_pop_up_in_category_management.png}}
		...
		\begin{figure}[!h]\centering
			\fbox{\includegraphics[width= 14cm]{./img/ch4/realUI/ui_subcategory_list_page_in_category_management.jpg}}
		...
		\begin{figure}[!h]\centering
			\fbox{\includegraphics[width= 14cm]{./img/ch4/realUI/ui_create_subcategory_list_page_in_category_management.png}}
...
\pagebreak
		\begin{figure}[!h]\centering
			\fbox{\includegraphics[width= 14cm]{./img/ch4/realUI/ui_edit_subcategory_list_page_in_category_management.png}}
...
\subsubsection{User Management} 
	\begin{figure}[!h]\centering
		\fbox{\includegraphics[width= 14cm]{./img/ch4/realUI/ui_user_list_page_in_user_management.jpg}}
...
\begin{figure}[!h]\centering
		\fbox{\includegraphics[width= 14cm]{./img/ch4/realUI/ui_create_user_page_in_user_management.jpg}}
...
\begin{figure}[!h]\centering
		\fbox{\includegraphics[width= 14cm]{./img/ch4/realUI/ui_user_information_page-in_user_management.jpg}}
...
\begin{figure}[!h]\centering
		\fbox{\includegraphics[width= 14cm]{./img/ch4/realUI/ui_edit_information_page_in_user_management.jpg}}
...
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 10cm]{./img/ch4/ch4_model_result.png}}
...
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 5cm]{./img/ch4/ch4_result_cosine.png}}
...
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 14cm]{./img/ch4/ch4_cosine_confuse.png}}
\caption{Cosine similarity confusion matrix}\label{fig:Cosine Confusion Metrix}
\end{figure} 
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 14cm]{./img/ch4/ch4_classfication_report_cosine.png}}
...
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 14cm]{./img/ch4/ch4_coco.png}}
...
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 14cm]{./img/ch4/ch4_cosine2_2.png}}
...
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 14cm]{./img/ch4/ch4_cococo.png}}
...
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 10cm]{./img/ch4/example_question_km.jpg}}
\caption{Example of question in knowledge management}\label{fig:km_question_example}
\end{figure}

\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 8cm]{./img/ch4/ch4_demo_correct.jpg}}
...
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 8cm]{./img/ch4/ch4_demo_wrong.jpg}}
...
\begin{figure}[!h]\centering
	\fbox{\includegraphics[width= 10cm]{./img/ch4/survey-result/chatbot_quality.jpg}}
...
\begin{figure}[!h]\centering
	\fbox{\includegraphics[width= 10cm]{./img/ch4/survey-result/chatbot_speed.jpg}}
...
%%%%%%%%%%%%%%%%%%%%%%%% Appendix %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\appendix{User Interface Design}
\noindent{\large\bf User Interface Design (Prototype)} \\
...
\indent{\large\bf Landing page} 
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 12cm]{./img/UI Design/Artboard 1logo2.jpg}}
...
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 12cm]{./img/UI Design/Artboard 1 copy 2logo2.jpg}}
...
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 12cm]{./img/UI Design/Artboard 1 copylogo2.jpg}}
...
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 12cm]{./img/UI Design/Artboard 1 copy 3logo2.jpg}}
...
\begin{figure}[!h]
	\centering
	\fbox{\includegraphics[width= 12cm]{./img/UI Design/question list.jpg}}
...
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 12cm]{./img/UI Design/question information.jpg}}
...
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 12cm]{./img/UI Design/create question.jpg}}
...
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 12cm]{./img/UI Design/edit question.jpg}}
...
\pagebreak
\noindent{\large\bf Category Management}
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 12cm]{./img/UI Design/category management.jpg}}
...
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 12cm]{./img/UI Design/create cate.jpg}}
...
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 12cm]{./img/UI Design/Edit cat.jpg}}
...
\pagebreak
\noindent{\large\bf Subcategory Management} 
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 12cm]{./img/UI Design/Sub cat.jpg}}
...
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 12cm]{./img/UI Design/create sub.jpg}}
...
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 12cm]{./img/UI Design/edit sub na.jpg}}
...
\pagebreak
\indent{\large\bf User Management}
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 12cm]{./img/UI Design/user list.jpg}}
...
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 12cm]{./img/UI Design/create user.jpg}}
...
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 12cm]{./img/UI Design/user info.jpg}}
...
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 12cm]{./img/UI Design/edit info.jpg}}
...
%%%%%%%%%%%%%%% The 2nd appendix %%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\appendix{Backend API Document}
\noindent{\large\bf Backend API Document} \\
...
\noindent{\large\bf System Evaluation Survey}
...
\begin{figure}[!h]\centering
	\fbox{\includegraphics[width= 10cm]{./img/ch4/survey-result/gender.jpg}}
	\caption{Gender of users}
\end{figure}

\begin{figure}[!h]\centering
	\fbox{\includegraphics[width= 10cm]{./img/ch4/survey-result/education_level.jpg}}
	\caption{Educational level of user}
\end{figure}

\begin{figure}[!h]\centering
	\fbox{\includegraphics[width= 10cm]{./img/ch4/survey-result/related_to_cpe.jpg}}
	\caption{Relation between user and computer engineering department of KMUTT}
\end{figure}
...
\begin{figure}[!h]\centering
	\fbox{\includegraphics[width= 5cm]{./img/ch4/survey-result/chatbot_can_answer.jpg}}
	\caption{Example of question that chatbot can answer from user}
\end{figure}

\begin{figure}[!h]\centering
	\fbox{\includegraphics[width= 5cm]{./img/ch4/survey-result/chatbot_cannot_answer.jpg}}
	\caption{Example of question that chatbot cannot answer from user}
\end{figure}

\begin{figure}[!h]\centering
	\fbox{\includegraphics[width= 5cm]{./img/ch4/survey-result/suggestion.jpg}}
