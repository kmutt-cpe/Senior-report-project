...
\pagebreak
		...
		\begin{flushleft}
			After we prepare the prerequisite, we send the app review request in pages_messaging for two times. The first time send is to check the missing. 
		\end{flushleft}
		\begin{figure}[!h]\centering
...
\pagebreak
		...
		\begin{flushleft}
			At last we get approve in the pages_messaging
		\end{flushleft}
		\begin{figure}[!h]\centering
