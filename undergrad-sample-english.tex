...
From the evaluation results of both models ~\ref*{evaluation prediction}.
The evaluation result of Siamese neural network model is better than the cosine simiarity model. Due  the aim of the prediction of the project is to classify both similar and not similar intent, Therefore the saimese neural netwoek model can both predict similar and not similar intent better than cosine similarity which can't classify not similar intent. In summary this is why Siamese neural network model is better than cosine. But the overall performance of the model is not good. The problem comes from not enough CPE questions data to train the Siamese neural network.
If we have more CPE questions data to train the Siamese neural network, we could improve the model's performance.
