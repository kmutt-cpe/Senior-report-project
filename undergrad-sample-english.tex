...
% todo: Add Logistic Regression content
...
\section{Problems}
Before deep down into the results of our project, let us explain problems that we found during
implement the project first. Because the results have changed a lot from our plan and it could
make you confused if not understand the problem and how we solve it. There are 3 major problems
that we want to describe first which are the performance problem, time exceed problem in Dialogflow,
and budget problem.
\subsection{Performance Problem}
% todo: Describe about the performance problem to send all question to predict and bad performance of dialogflow intent
\subsubsection{Solution of Performance Problem}
% todo: Create the category model to classify category of question before put into question prediction model
\subsection{Time Exceed in Dialogflow Problem}
% todo: The problem occur when integrate the whole system together. Dialogflow have very short timeout.
% todo: Add the performance image of pattern1.
\subsubsection{The First Approach for Solving Time Exceed in Dialogflow Problem}
\subsubsection{The Second Approach for Solving Time Exceed in Dialogflow Problem}
\subsubsection{The Last Approach for Solving Time Exceed in Dialogflow Problem}
