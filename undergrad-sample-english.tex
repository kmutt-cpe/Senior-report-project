...
We tested the model on three different computers: Natthawat's PC, Nathaphop's PC, and A-Square lab's computer.
...
\begin{table}[h]
	...
	\begin{adjustbox}{width=\textwidth}
		\begin{tabular}{|l|l|l|l|}
			...
			Natthawat's PC &                                  &     &               \\ \hline
			Nathaphop's PC & AMD Ryzen 7 3700X & NVIDIA Gefore RTX 3080 & DDR4 3200 32GB (16GBx2) \\ \hline
			A-Square lab's computer &                                  &     &            \\ \hline
		\end{tabular}
	\end{adjustbox}
\end{table}
...
The result is in Table~\ref*{tab:run_time_pattern1_table}.
The time summation in each computer is greater than timeout response of Dialogflow.
...
\begin{table}[h]
	...
	\begin{adjustbox}{width=\textwidth}
		\begin{tabular}{|l|l|l|l|}
			\hline
			\backslashbox{Computer name}{Time usage to predict each model} & Category model & Siamese neural network model & Time summation \\ \hline
			Natthawat's PC &                              &                                       &    \\ \hline
			Nathaphop's PC &                              &                                        &   \\ \hline
			A-Square lab's computer &                              &                                &           \\ \hline
		\end{tabular}
	\end{adjustbox}
\end{table}
