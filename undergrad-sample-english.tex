...
a friend and have many features such as translate, find nearest restaurant, etc.\\
...
can integrate Botnoi to the system such as Botnoi API, external API intregration, AI training
