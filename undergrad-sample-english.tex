...
Now our chatbot subsystem which we implement in dialogflow can greeting and understand what is the question and for storage subsystem which we implement in GraphQL query category from backend API. Now our system can category of FAQs by ID and can query FAQs from all category.
