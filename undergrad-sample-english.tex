...
\pagebreak		
		\begin{figure}[!h]\centering
			\fbox{\includegraphics[width=14cm]{./img/ch4/cloudflare_dns.png}}
			\caption{Cloudflare DNS page}\label{fig:Cloudflare DNS page}
		\end{figure}
		In the ssl mode, Full strict mode is selected in this ssl
		\begin{figure}[!h]\centering
			\fbox{\includegraphics[width=14cm]{./img/ch4/cloudflare_ssl_overview.png}}
			\caption{Cloudflare ssl overview page}\label{fig:Cloudflare ssl overview page}
		\end{figure}
\pagebreak
		\begin{figure}[!h]\centering
			\fbox{\includegraphics[width=14cm]{./img/ch4/cloudflare_ssl_origin.png}}
...
\section{Chatbot Subsystem Results}
	...
	\begin{figure}[!h]\centering
		\fbox{\includegraphics[width=8cm]{./img/ch4/ch4_1_2.png}}
...
\pagebreak
		...
		\end{flushleft}
		\begin{figure}[!h]\centering
			\fbox{\includegraphics[width=14cm]{./img/ch4/dialogflow_integration_messenger.png}}
		...
		\end{flushleft}
		\begin{figure}[!h]\centering
			\fbox{\includegraphics[width=14cm]{./img/ch4/dialogflow_fullfillment.png}}
			\caption{Dialogflow fullfillment}\label{fig:Dialogflow fullfillment}
		\end{figure}
\pagebreak
	\subsection{Facebook Messenger}
		% todo: facebook messenger detail
		\begin{flushleft}
		...
		\end{flushleft}
		\begin{figure}[!h]\centering
			\fbox{\includegraphics[width=14cm]{./img/ch4/facebook_developer_app.png}}
		...
		\end{flushleft}
		\begin{figure}[!h]\centering
			\fbox{\includegraphics[width=14cm]{./img/ch4/facebook_settings_basic_privacy_policy_and_term_of_service.png}}
			...
			\fbox{\includegraphics[width=14cm]{./img/ch4/facebook_settings_basic_business.png}}
...
\pagebreak
		...
		\end{flushleft}
		\begin{figure}[!h]\centering
			\fbox{\includegraphics[width=14cm]{./img/ch4/facebook_roles.png}}
		...
		\end{flushleft}
		\begin{figure}[!h]\centering
			\fbox{\includegraphics[width=14cm]{./img/ch4/facebook_appreview_requests.png}}
...
\pagebreak
		...
		\begin{figure}[!h]\centering
			...
			\fbox{\includegraphics[width=14cm]{./img/ch4/facebook_appreview_Permissions_and_Features.png}}
...
\pagebreak
		...
		\end{flushleft}
		\begin{figure}[!h]\centering
			\fbox{\includegraphics[width=14cm]{./img/ch4/facebook_messenger_settings.png}}
...
\pagebreak
	...
	% todo: make the use case narrative relate to the use case diagram
	\subsubsection{Login}
...
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 14cm]{./img/ch4/Database Schema.png}}
...
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 10cm]{./img/ch4/ch4_demo1.jpg}}
...
\end{figure}
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 10cm]{./img/ch4/ch4_demo2.jpg}}
...
\end{figure}
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 10cm]{./img/ch4/ch4_demo3.jpg}}
...
\end{figure}
\begin{figure}[!h]\centering
\fbox{\includegraphics[width= 10cm]{./img/ch4/ch4_demo4.jpg}}
...
Figure 4.1 is a home page design of website which contains about features and detail 
about knowledge management. In this page there are menu bar on the top right which consist 
of home page, contact page (Figure 4.2), and login page (Figure 4.3).

Figure 4.2 is contact page which contains about member in team and our advisor. In 
this page there are menu bar on the top right which same as the home page (Figure 4.1)

Figure 4.3 is login page which contains only box to login in the center of page. Users 
can input their username and password to login to the system. If username and password are 
valid, it will redirect to question management (Figure 4.4). On the other hand, if username 
or password is invalid, the website will display error message and tell that username or 
password is not correct.

The first page of question management is category selection (Figure 4.4). When user 
...
click on the category card, it will redirect to question list page (Figure 4.5) of that category.

Figure 4.5 is the question list page of each category. It displays the question list in 
pagination. User can select page number and select number of questions in each page at the 
bottom below (No.1 on figure 4.5)

User can click create new question (No.2 on figure 4.5) to add the new question to 
knowledge management. When user click on that button, it will redirect to create question 
page (Figure 4.7). Also, user can click on the row of question (No.3 on figure 4.5) to redirect 
...
information of question. When user click, it will redirect to edit question page (Figure 4.8). 
On the other hand, if user want to delete that question, user can click the red trash can in 
action column (No.5 on figure 4.8). When click the red trash can, it will pop up the 
...
selection page (Figure 4.4)

Figure 4.6 is the question information. This page contains information of question 
(No.1 on Figure 4.6) and action buttons (No.2 on Figure 4.6).
...
delete button. When user clicks edit button, it will redirect to edit question page (Figure 4.8). 
Also, when user clicks the delete button, it will pop up the confirmation box to let user 
confirm of delete action and redirect back to question list page (Figure 4.5). And user can 
click back button on the top left (No.3 on Figure 4.6) to go back to question list page (Figure 
4.5)

Figure 4.7 is the create question page in question management. This page contains 
only input box at the center (No.1 on Figure 4.7) and action button at the right bottom of 
page (No.2 on Figure 4.7).
...
Figure 4.8 is the edit question page in question management. This page is almost as 
same as create question page (Figure 4.7) except there are the information of question that 
has create before. User can edit information and save new information to the system by 
clicking save button at the right bottom of page (No.1 on Figure 4.8)

Figure 4.9 is the category list page of category management. It displays the category
list in pagination. User can select page number and select number of categories in each page 
at the bottom below (No.1 on figure 4.9).
User can click create new category (No.2 on figure 4.9) to add the new category to 
knowledge management. When user click on that button, it will pop-up create category
(Figure 4.10). Also, user can click on the row of category (No.3 on figure 4.9) to redirect to 
subcategory list page (Figure 4.11) to show the subcategory of the category. In addition, 
user can search the category by typing on search box (No.4 on Figure 4.9)
Also, user can click the pencil in action column (No.5 on Figure 4.9) to edit category
name. When user click, it will pop up to edit category (Figure 4.11). On the other hand, if 
user want to delete that category, user can click the red trash can in action column (No.5 on 
figure 4.9). When click the red trash can, it will pop up the confirmation box to let user 
confirm of delete action.

Figure 4.10 is the create category pop-up in category management. This pop-up
contains only input box at the center (No.1 on Figure 4.10) and create button at the middle 
bottom of page (No.2 on Figure 4.10) and cross button at the top right for close pop-up (No.3 
on Figure 4.10).
...
Figure 4.11 is the edit category name pop-up in category management. This pop-up 
contains only input box at the center (No.1 on Figure 4.11) and save button at the middle 
bottom of page (No.2 on Figure 4.11) and cross button at the top right for close pop-up (No.3
on Figure 4.11).
Users need to input the category in the input boxes. After that user can decide to 
...
Figure 4.15 is the user list page of user management. It displays the user list in 
pagination. User can select page number and select number of users in each page at the 
bottom below (No.1 on figure 4.15).
User can click create new user (No.2 on figure 4.15) to add the new user to 
knowledge management. When user click on that button, it will redirect to create user page 
(Figure 4.16). Also, user can click on the row of user (No.3 on figure 4.15) to redirect to 
user information page (Figure 4.17) to read the information such as role, username and 
name. In addition, user can search the question by typing on search box (No.4 on Figure 
4.15)
Also, user can click the pencil in action column (No.5 on Figure 4.15) to edit 
information of user. When user click, it will redirect to edit user page (Figure 4.18). On the 
other hand, if user want to delete that user, user can click the red trash can in action column 
(No.5 on figure 4.15). When click the red trash can, it will pop up the confirmation box to 
let user confirm of delete action.

Figure 4.16 is the create user page in user management. This page contains only 
input box at the center (No.1 on Figure 4.7) and action button at the right bottom of page 
(No.2 on Figure 4.7).
